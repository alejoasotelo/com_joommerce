...
// Parse input options
$options = getopt('', array('help', 'from::', 'version::'));

$from       = $options['from'];
$version       = isset($options['version']) ? $options['version'] : '<version>';
...
mkdir($fullpath);
*/
$data = '# Versión '.$version.' - '.date('d/m/Y');
$data .= "\n\n";
...
$filename = $here. DIRECTORY_SEPARATOR . '../CHANGELOG.md';
