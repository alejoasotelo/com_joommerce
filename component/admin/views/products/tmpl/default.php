			...
			<thead>
				<tr>
					...
					<th style="min-width:100px" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'COM_JOOMMERCE_PRODUCTS_NAME', 'name', $listDirn, $listOrder); ?>
					</th>
			...
			<tbody>
				<?php if (!empty($this->items)) : ?>
					<?php foreach ($this->items as $i => $row) :
						$link = JRoute::_('index.php?option=com_joommerce&task=product.edit&id=' . $row->id);
					?>
						<tr>
