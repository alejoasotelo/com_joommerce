...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "orderproduct.cancel" || document.formvalidator.isValid(document.getElementById("adminForm")))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_joommerce&layout=edit&id=' . (int) $this->item->id); ?>"
    ...
    <div class="form-horizontal">
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_JOOMMERCE_ORDER_PRODUCT_DETAILS'); ?></legend>
            <div class="row-fluid">
                <div class="span6">
                    <?php 
    ...
    <input type="hidden" name="task" value="orderproduct.edit" />
