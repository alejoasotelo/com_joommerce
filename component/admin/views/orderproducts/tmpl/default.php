...
?>
<form action="index.php?option=com_joommerce&view=orderproducts" method="post" id="adminForm" name="adminForm">
			...
			<thead>
				<tr>
					...
					<th style="min-width:100px" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'COM_JOOMMERCE_ORDER_PRODUCTS_NAME', 'name', $listDirn, $listOrder); ?>
					</th>
			...
			<tbody>
				<?php if (!empty($this->items)) : ?>
					<?php foreach ($this->items as $i => $row) :
						$link = JRoute::_('index.php?option=com_joommerce&task=orderproduct.edit&id=' . $row->id);
					?>
						<tr>
							...
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $row->published, $i, 'orderproducts.', true, 'cb'); ?>
							</td>
							<td>
