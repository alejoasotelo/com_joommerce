...
// Require helper file
JLoader::register('JoommerceHelper', JPATH_COMPONENT . '/helpers/joommerce.php');
...
new HotReloader\HotReloader('//127.0.0.1/administrator/components/com_joommerce/phrwatcher.php');